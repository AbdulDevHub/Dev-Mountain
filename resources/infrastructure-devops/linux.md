...
:::tip Related
Working on Windows instead? See [Useful Terminal Commands](../scripting-automation/terminal-commands.md) for the PowerShell / Node.js equivalents (project linting, file management, duplicate detection, etc.).
:::
