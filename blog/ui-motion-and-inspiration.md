...
A curated list of **CodePen demos, animation libraries, motion tools, and visual inspiration** for modern web interfaces.
...
- [Rellax.js](https://yaireo.github.io/rellax/)
- [Motion Primitives](https://motion-primitives.com/)
- [Vanta.js – Waves Effect](https://www.vantajs.com/?effect=waves)
- [@codaworks/react-glow](https://www.npmjs.com/package/@codaworks/react-glow)
- [ShaderToy – Fragment Shader Example](https://www.shadertoy.com/view/fstyD4)

---

## 🎞️ Lottie, Loaders & Visual Assets

- [LottieFiles](https://lottiefiles.com/)
- [UI Ball Loaders](https://uiball.com/ldrs/)
- [HTML5 Animation to GIF](https://html5animationtogif.com/)
- [fffuel – SVG & CSS Generators](https://www.fffuel.co/)

---

## 🧠 Inspiration & Case Studies

- [Nuxt.com Source Code](https://github.com/nuxt/nuxt.com)
- [Vercel – Interactive 3D Event Badge](https://vercel.com/blog/building-an-interactive-3d-event-badge-with-react-three-fiber)
- [Vercel Text Gradient Experiment](https://kevinhufnagl.com/verceltext-gradient/)
- [Linear App – Motion & UX Reference](https://linear.app/)
- [YouTube – Creative UI Animation Walkthrough](https://www.youtube.com/watch?v=CJ26NLtdzPA)

---

## 🧠 Notes

- Great reference for **micro-interactions**
- Useful for **landing pages & portfolios**
- Many demos are **framework-agnostic**
- Ideal for experimenting with **motion-driven UX**
